      ...
      {syncMutation.isPending && (
        <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          <div className="flex items-center gap-2 text-blue-800 dark:text-blue-200">
            ...
            <span className="font-medium">Syncing Orphadata Database</span>
          </div>
          <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
            Updating rare disease knowledge base with latest information from Orphanet...
          </p>
        </div>
      )}

      {/* Quick Actions Bar */}
      <div className="bg-gradient-to-r from-blue-50 to-emerald-50 dark:from-blue-950/20 dark:to-emerald-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-slate-900 dark:text-slate-100">Database Management</h3>
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Keep your rare disease knowledge base current with the latest medical research
            </p>
          </div>
          <div className="flex items-center gap-3">
            <Badge variant="secondary" className="text-xs px-3 py-1">
              {analytics?.knowledgeBaseSize || 0} diseases loaded
            </Badge>
            <Button
              onClick={handleSync}
              disabled={syncMutation.isPending}
